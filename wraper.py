...
class Wraper:
    """
    Wraper class for use in file opening in PrimerDesign.
    Wraps different methods from file openers for different
    ...
    def __init__(self, file_name, use):
        """
        Create a Wraper object for the specified file and use.
        """
        self.supported = {
